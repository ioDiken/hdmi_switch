...
## Pmod Header JB
set_property -dict { PACKAGE_PIN W14   IOSTANDARD LVCMOS33 } [get_ports { PM_DVI_B[3] }]; #IO_L8P_T1_34 Sch=JB1_P
set_property -dict { PACKAGE_PIN Y14   IOSTANDARD LVCMOS33 } [get_ports { PM_DVI_CLK }]; #IO_L8N_T1_34 Sch=JB1_N
set_property -dict { PACKAGE_PIN T11   IOSTANDARD LVCMOS33 } [get_ports { PM_DVI_B[0] }]; #IO_L1P_T0_34 Sch=JB2_P
set_property -dict { PACKAGE_PIN T10   IOSTANDARD LVCMOS33 } [get_ports { PM_DVI_HS }]; #IO_L1N_T0_34 Sch=JB2_N
set_property -dict { PACKAGE_PIN V16   IOSTANDARD LVCMOS33 } [get_ports { PM_DVI_B[2] }]; #IO_L18P_T2_34 Sch=JB3_P
set_property -dict { PACKAGE_PIN W16   IOSTANDARD LVCMOS33 } [get_ports { PM_DVI_B[1] }]; #IO_L18N_T2_34 Sch=JB3_N
set_property -dict { PACKAGE_PIN V12   IOSTANDARD LVCMOS33 } [get_ports { PM_DVI_DE }]; #IO_L4P_T0_34 Sch=JB4_P
set_property -dict { PACKAGE_PIN W13   IOSTANDARD LVCMOS33 } [get_ports { PM_DVI_VS }]; #IO_L4N_T0_34 Sch=JB4_N
