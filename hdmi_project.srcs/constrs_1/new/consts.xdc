...
create_clock -add -name sys_clk_pin -period 8.00 -waveform {0 4} [get_ports { CLK}];#set // what mhz is this clk?
...
set_property -dict { PACKAGE_PIN W20   IOSTANDARD TMDS_33  } [get_ports { HDMI_RX0_DATA_N[0] }]; #IO_L16N_T2_34 Sch=HDMI_RX_D0_N
set_property -dict { PACKAGE_PIN V20   IOSTANDARD TMDS_33  } [get_ports { HDMI_RX0_DATA_P[0] }]; #IO_L16P_T2_34 Sch=HDMI_RX_D0_P
set_property -dict { PACKAGE_PIN U20   IOSTANDARD TMDS_33  } [get_ports { HDMI_RX0_DATA_N[1] }]; #IO_L15N_T2_DQS_34 Sch=HDMI_RX_D1_N
set_property -dict { PACKAGE_PIN T20   IOSTANDARD TMDS_33  } [get_ports { HDMI_RX0_DATA_P[1] }]; #IO_L15P_T2_DQS_34 Sch=HDMI_RX_D1_P
set_property -dict { PACKAGE_PIN P20   IOSTANDARD TMDS_33  } [get_ports { HDMI_RX0_DATA_N[2] }]; #IO_L14N_T2_SRCC_34 Sch=HDMI_RX_D2_N
set_property -dict { PACKAGE_PIN N20   IOSTANDARD TMDS_33  } [get_ports { HDMI_RX0_DATA_P[2] }]; #IO_L14P_T2_SRCC_34 Sch=HDMI_RX_D2_P
